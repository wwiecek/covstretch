...
It appears that the improvement is greater when population mixing is heterogeneous. 
...
for (i in (1:nrow(results_all))) {
  if (results_all$recurring[[i]][4] == 1) {
    vec[i] <- F
  } else {
    vec[i] <- T
  }
...
results_all$recurring <- vec

```

```{r warning=FALSE, message=FALSE,fig.fullwidth=T, fig.cap="Percent of Death in Covid Pandemic under Dynamic Optimization", fig.pos="H"}
results_all %>% 
...
```{r warning=FALSE, message=FALSE, fig.full_width=T, fig.cap="Percent of Cumulative Infections in Covid Pandemic under Dynamic Optimization", fig.pos="H"}
results_all %>% 
...
```{r warning=FALSE, message=FALSE,fig.fullwidth=T, fig.cap="Percent of Death in Covid Pandemic under Static Optimization", fig.pos="H"}
results_all %>% 
...
```{r warning=FALSE, message=FALSE,fig.fullwidth=T, fig.cap="Percent of Cumulative Infection in Covid Pandemic under Static Optimization", fig.pos="H"}
results_all %>% 
...
```{r warning=FALSE, message=FALSE,fig.fullwidth=T, fig.height = 3, fig.cap="Optimal Age-specific Dose Fractions for Recurring Slow Covid Pandemic in High-income Countries under Dynamic Optimization for Minimizing Death Percent", fig.pos="H"}
results_all %>% 
  rowwise() %>% 
  filter(recurring) %>%
...
```{r warning=FALSE, message=FALSE,fig.fullwidth=T, fig.height = 3, fig.cap="Optimal Age-specific and Uniform Dose Fraction for Recurring Slow Covid Pandemic in High-income Countries under Dynamic Optimization for Minimizing Death Percent", fig.pos="H"}
results_all %>% 
  filter(recurring) %>%
  plot_frac_age(fix_1_name = "objective", fix_1_value = "D", 
                fix_2_name = "pdeath", fix_2_value = "ifr_hic",
...
```{r warning=FALSE, message=FALSE,fig.fullwidth=T, fig.height = 3, fig.cap="Optimal Age-specific Dose Fraction for Recurring Slow Covid Pandemic with heterogeneous mixing and a 300-day campaign under Dynamic Optimization", fig.pos="H"}
results_all %>% 
  filter(recurring) %>%
...
```{r warning=FALSE, message=FALSE,fig.fullwidth=T, fig.height = 3, fig.cap="Optimal Age-specific Dose Fraction for Recurring Covid Pandemic in High-income Country with heterogeneous mixing and a 300-day campaign under Dynamic Optimization", fig.pos="H"}
results_all %>% 
  filter(recurring) %>%
  plot_frac_age(fix_1_name = "q", fix_1_value = "300", 
                fix_2_name = "homogen_mixing", fix_2_value = F,
...
```{r fig.fullwidth=T, fig.height = 3, fig.cap="Optimal Age-specific Dose Fraction for Recurring Slow Covid Pandemic in High-income Countries under Dynamic Optimization for Minimizing Death Percent", fig.pos="H", eval=FALSE}
results_all %>% 
  filter(recurring) %>%
  plot_frac_age(fix_1_name = "objective", fix_1_value = "D", 
                fix_2_name = "pdeath", fix_2_value = "ifr_hic",
