...
\dot{N}_i^1(t) &= v_i^1(t) \delta_i^1 \frac{(1 - e_i^1) S_i(t)}{S_i(t) + vrf R_i(t)} + \kappa_i^1 V_i^1(t) - \lambda_i(t) N_i^1(t) \\
...
* What is *constantrisk*? To delete
* What is $\phi_i$?
* What is *vrf*? To delete
