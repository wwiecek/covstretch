...
ggsave(paste0(fig_folder, "/g2.pdf"), fig_g2, width = 5.55, height=7)
ggsave(paste0(fig_folder, "/g2_reductions_only.pdf"), g2b, width = 5.55, height=4)
...
ggsave(paste0(fig_folder, "/supply_impact.pdf"), fig_extra_supply, width = 5.55, height=3.4)
